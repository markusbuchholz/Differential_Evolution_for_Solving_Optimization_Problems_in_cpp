// Markus Buchholz
// g++ differential_evolution_robot3D.cpp -o t -I/usr/include/python3.8 -lpython3.8
...
Pos posCrossover(Pos mut, Pos old)
{
    ...
    if (rnd < CR)
    {
        ...
        int cross = dimensionToUpdate(2);

        if (cross == 0)
        {

            int xyz = dimensionToUpdate(2);
